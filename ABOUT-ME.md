...
Then I started diving into deeper concepts like Neural Networks, Game Design, Programming Language Design (mainly interpreters at this point), and LeetCode-style problems. This whole experience taught me that if I spend 3+ hours a day learning something consitently for months, I can surpass everyone around me & learn a whole bunch of new and intresting things.
...
I also use C++ for developing with PROS for Vex V5 along with some esp32 based robotics. C++ introduced me to deeper concepts such as raycasting, compiler design, assembly, CPU architecture, OS internals, and why compiled programs can only run on specific machines.
...
*Sadly, I lost many of the projects I mentioned above due to Windows corrupting itself, so I switched to Manjaro Linux and started using Git/GitHub to store my more recent projects. although you wont see as many projects being made because I went from spending all of my time making projects to trying to learn as much as possible and be as good as I can possibly be with C.*
...
He then assigned me and two friends to a special project where we built an RC car. I programmed and designed the circuit, another friend helped build it, and the third CAD-modeled and built the body. After that, he had the rest of the class start using Arduino, and I helped teach by designing circuits and writing example programs along with debugging a whole lot of other peoples code.

Two weeks after he mentioned Fortran, I got curious, joined the Fortran subreddit, found a Fortran-77 guide & a Fortran-90 guide, installed gfortran, and started making a bunch of programs — before eventually writing my own Fortran compiler in C++ (which I sadly lost due to Windows).
...
I Wouldnt consider myself good at Java by any means, mainly because I have no drive or reason to learn it, since it is barely alligned with my interests, plus I hate almost everything about it. 
